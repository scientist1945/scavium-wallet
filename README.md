...
- Phase 9.4.1 completed — Light/Dark Theme Baseline and Token Boundary; documented the boundary between dark-oriented tokens, future paired `ThemeData` construction, and deferred runtime selection/persistence.
